...
values  (DEFAULT,'Manuel Pereira',     'manuel345@hotmail.com','983838383','Av. Eng. Adelino Amaro da Costa,485,2750-642,Cascais'), -- [Street],[Number],[Postal code],[City]
        (DEFAULT,'Josefina Silva',     'jsilva.pt@gmail.com',  '916990129','Casal da Torre,4,2775-405,Carcavelos'),
        (DEFAULT,'Daniela Belchior',   'danibel98@hotmail.com','982942069','R. Actriz Adelina Fernandes,21B,2795-092,Linda-a-Velha'),
        (DEFAULT,'Francisco Rodrigues','kikorod@sapo.pt',      '952637194','R. Prof. Xavier Morato,8,1600-598,Lisboa'),
        (DEFAULT,'Miguel Seleiro',     'mseleiro@gmail.com',   '965783162','R. Dom Afonso Henriques,49,2695-691,São João da Talha');

START TRANSACTION;
SET CONSTRAINTS ALL DEFERRED; -- Because of IC 3
insert into orders
values  (DEFAULT,1,'2023-01-01'),
        (DEFAULT,2,'2023-02-13'),
        (DEFAULT,3,'2023-04-09'),
        (DEFAULT,1,'2023-05-27'),
        (DEFAULT,5,'2023-11-25'),
        (DEFAULT,3,'2023-12-12'),
        (DEFAULT,4,'2023-12-30'),
        (DEFAULT,5,'2023-01-27');

insert into product
values  ('BAN-12345','Banana',                'Bananas from Madeira 1kg',                     2.82,  'GS17389134814'),
        ('SAL-67890','Salt',                  'Thin salt 1kg',                                2.18),
        ('BW-13579', 'Body Gel',              'Dove Body Gel with orange scent 750ml',        6.49),
        ('RIC-24680','White Rice',            'Auchan white rice 250g',                       1.49,  'GS19394859123'),
        ...
        ('WAB-12312','Wagyu Beef',            'Premium gourmet japanese beef',                126.85,'GS11279312789');
...
values  ('R. Rui Teles Palhinha,6,2740-278,Porto Salvo',  25.6,893.90),
        ...
        ('R. Rui Teles Palhinha,8,2740-278,Porto Salvo', 15.6,80.1),
...
values  ('R. Rui Teles Palhinha,6,2740-278,Porto Salvo'),
        ('Pátio do Tijolo,11,1200-230,Lisboa'),
...
insert into works
values  ('398-25-9710','Human Resources',   'R. Rui Teles P,lhnha 6, 2,40-278 Porto Salvo'),
...
values  ('R. Rui Teles P,lhnha 6, 2,40-278 Porto Salvo',              '12839471-ST'),
        ('Pátio do Tijolo,11,1200-230,Lisboa',      '10123943-MP'),
        ('R. Rui Teles P,lhnha 6, 2,40-278 Porto Salvo',              '14958313-DL'),
