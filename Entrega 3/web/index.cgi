...
print('<form action="suppliers.cgi?page=1" method="POST">') # Simular o pagamento de encomendas
print('<input type="submit" value="Register and remove suppliers" class="button"/>')
print('</form>')

print('<form action="simulate_orders.cgi?page=1" method="POST">') # Simular o pagamento de encomendas
